...
def start_anim(objective_func):
    ...
    max_iterations = 60
    minimize = True
    pso = ParticleSwarm(objective_func, lb, ub, num_dimensions, options={'SwarmSize': num_particles, 'MaxIterations': max_iterations, 'Tolerance':tolerance}, minimize= minimize, isanimated=True)
